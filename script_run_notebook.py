...
subscription_id = "e50b076f-e147-4774-b645-ece6875a20ca"
resource_group = "AZML-MSDE"
workspace_name = "AZML"
...
myenv = Environment.get(ws, 'AzureML-AutoML', '123')
...
training_dataset_id = '059cca3b-18a6-49dd-9152-a3a51e06c715'
dataset_arguments = ['--training_dataset_id', training_dataset_id]

create_run_dto = CreateRunDto(run_id=codegen_runid,
                              parent_run_id='AutoML_8566a5b7-eeaf-4768-b80c-9f044396ae13_40',
